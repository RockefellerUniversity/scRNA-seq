...
3. Mmake a dot plot for nCount_RNA vs nFeature_RNA. *NOTE: Try to keep an eye out potential doublets.*
```{r,echo=toMessage}
FeatureScatter(obj,feature1="nCount_RNA",feature2="nFeature_RNA")
```

4. Make a dot plot for nCount_RNA vs percent.mt. *NOTE: Try to keep an eye out potential doublets.*
```{r,echo=toMessage}
