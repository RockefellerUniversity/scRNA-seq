...
---
## Session information
```{r scSeq_GI_sessionInfot,echo=FALSE,out.width = "50%",fig.align="center"}
knitr::include_graphics("imgs/session_info.png")
```

---
## Sequencing QC
```{r scSeq_GI_seqQC,echo=FALSE,out.width = "50%",fig.align="center"}
knitr::include_graphics("imgs/seq_qc.png")
```

---
## Mapping QC
```{r scSeq_GI_mapQC,echo=FALSE,out.width = "50%",fig.align="center"}
knitr::include_graphics("imgs/map_info.png")
```

---
## General information
```{r scSeq_GI_cellCount2,echo=FALSE,out.width = "50%",fig.align="center"}
knitr::include_graphics("imgs/cell_count.png")
```
...
```{r scSeq_GI_detCellNum,echo=FALSE,out.width = "25%",fig.align="center"}
...
---
## genes vs throughput
```{r scSeq_GI_geneEvl,echo=FALSE,out.width = "50%",fig.align="center"}
...
```{r scSeq_GI_satPlot,echo=FALSE,out.width = "25%",fig.align="center"}
...
```{r scSeq_GI_tsnePlot,echo=FALSE,out.width = "75%",fig.align="center"}
