...
In this session, we will introduce the default results of [Cell Ranger](https://support.10xgenomics.com/single-cell-gene-expression/software/pipelines/latest/what-is-cell-ranger), which is the most commonly used for 10X Genomics single-cell squencing data analysis.
- [QC Report]("data/WT.html")
- cloupe file: can be processed by [LOUPE Browder](https://support.10xgenomics.com/single-cell-gene-expression/software/visualization/latest/what-is-loupe-cell-browser)
