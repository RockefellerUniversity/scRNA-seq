...
---
## SeuratWrappers
- Seurat objects can be converted into different objects for further analysis
- detailed information please refer to [SeuratWrappers](https://github.com/satijalab/seurat-wrappers)
