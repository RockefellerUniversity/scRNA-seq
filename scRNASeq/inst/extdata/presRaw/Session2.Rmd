...
- The data is available on [BOX](https://rockefeller.box.com/s/hdy0vex38dlph5pglafrkw68b7uemndr)
...
```{r eval_readCount_geneCount_mitoCont,echo=TRUE,eval=TRUE,include=TRUE,fig.height=3,fig.width=3}
...
---
## Cell cycle ~ phase
```{r cellCycle_plot2,echo=TRUE,eval=TRUE,include=TRUE,fig.height=4,fig.width=2}
library(ggplot2)
...
```{r pcSel,echo=TRUE,eval=TRUE,include=TRUE,fig.height=4,fig.width=4}
...
---
## Exercise time
- [Exerise](../../exercises/exercises/exercise1_exercise.html)
- [Answer](../../exercises/answers/exercise1_answers.html)